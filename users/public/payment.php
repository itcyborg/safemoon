                        ...
                        <div class="card-content">
                            <form action="../../functions/constructor.php" id="payform" method="post">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <div class="col-lg-5 col-sm-12col-md-8">
                                        <div class="card card-stats col-lg-12 col-sm-12 col-md-12">
                                            <div class="card-header col-lg-11 col-sm-12">Payment Information</div>
                                            <div class="card-content text-center">
                                                Paybill No: 678449<br>
                                                Account: Safemoon<br>
